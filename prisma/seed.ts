...
`
  ...
  const games = [
    {
      title: "Don't Touch My Color",
      slug: 'dont-touch-my-color',
      shortDescription: 'A fast-paced arcade game where you must avoid touching the wrong colors. Test your reflexes and see how far you can go!',
      fullDescription: "Don't Touch My Color is a fast-paced arcade game where you must avoid touching the wrong colors. Test your reflexes and see how far you can go! Simple to learn, hard to master — perfect for short play sessions.",
      coverImage: '/games/dont-touch-my-color.png',
      genre: 'Puzzle / Arcade',
      appStoreUrl: '',
      googlePlayUrl: '',
      webUrl: 'https://emirhanmamak.itch.io/dont-touch-my-color',
      featured: true,
      published: true,
      sortOrder: 0,
    },
    {
      title: 'Jump to Freedom',
      slug: 'jump-to-freedom',
      shortDescription: 'A challenging platformer where precise jumps lead you to freedom. Every level tests your timing and skill.',
      fullDescription: 'Jump to Freedom is a challenging platformer where precise jumps lead you to freedom. Every level tests your timing and skill. Navigate tricky obstacles, master the controls, and reach the goal in this satisfying web-based platformer.',
      coverImage: '/games/jump-to-freedom.png',
      genre: 'Platformer',
      appStoreUrl: '',
      googlePlayUrl: '',
      webUrl: 'https://emirhanmamak.itch.io/jump-to-freedom',
      featured: true,
      published: true,
      sortOrder: 1,
    },
    {
      ...
      slug: 'journey-to-victory',
      shortDescription: 'An adventurous journey filled with obstacles and triumphs. Explore, adapt, and conquer your way to victory.',
      fullDescription: 'Journey to Victory is an adventurous web game filled with obstacles and triumphs. Explore, adapt, and conquer your way to victory. A solo-developed experience built with passion and polished gameplay.',
      coverImage: '/games/journey-to-victory.png',
      genre: 'Adventure',
      appStoreUrl: '',
      googlePlayUrl: '',
      webUrl: 'https://emirhanmamak.itch.io/journy-to-victory',
      featured: false,
      published: true,
      sortOrder: 2,
    },
