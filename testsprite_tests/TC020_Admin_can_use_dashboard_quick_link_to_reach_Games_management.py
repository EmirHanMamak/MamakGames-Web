...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with admin@mamakgames.com and the password field with admin123, then submit the form.
        ...
        # -> Retry signing in using admin@mamakgames.com with the alternate password mamakgames2026, then submit the form.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Manage Games')]").nth(0).is_visible(), "The games management page should be displayed after clicking the quick link."
