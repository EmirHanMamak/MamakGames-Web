...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the admin login page (/admin/login) to begin signing in as the admin user.
        await page.goto("http://localhost:3030/admin/login")
        
        # -> Fill the email and password fields and click 'Sign In' to authenticate as admin, then wait for the dashboard to load and verify the stat cards and unread submissions indicator.
