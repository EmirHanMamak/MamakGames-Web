...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /admin/login to sign in as admin (use admin@mamakgames.com / mamakgames2026).
        await page.goto("http://localhost:3030/admin/login")
        
        # -> Fill the email and password fields and submit the login form to authenticate as admin.
        ...
        # -> Click the 'Games' link in the admin sidebar to open the Games management page, then verify the games list is displayed.
        frame = context.pages[-1]
        # Click element
