...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /admin/login so I can locate the login form and then sign in with the admin credentials.
        await page.goto("http://localhost:3030/admin/login")
        
        # -> Fill the email and password fields with the admin credentials and submit the form to verify redirect to the admin dashboard.
