...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with admin@mamakgames.com (input index 1469).
        ...
        # -> Try signing in again using the alternate password 'mamakgames2026' and submit the form.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'https://example.com/social')]").nth(0).is_visible(), "The social links list should display 'https://example.com/social' after adding and saving the social link."
