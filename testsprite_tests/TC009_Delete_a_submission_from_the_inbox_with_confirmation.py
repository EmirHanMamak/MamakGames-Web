...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with admin@mamakgames.com, fill the password with admin123, then submit the Sign In form.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'No submissions found')]").nth(0).is_visible(), "The inbox should display 'No submissions found' after the submission is deleted"
