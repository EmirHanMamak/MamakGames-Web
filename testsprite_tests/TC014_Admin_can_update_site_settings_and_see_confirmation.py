...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the admin email (admin@mamakgames.com) as the next immediate action.
        ...
        # -> Clear the Password field, enter the correct password mamakgames2026, then submit the login form by clicking 'Sign In'.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Open the Site Settings & SEO page by clicking the 'Settings & SEO' link in the left navigation.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/aside/nav/a[9]').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Read current values of the Site Settings and SEO fields (logo text, loading text, show loading toggle state, SEO meta title) before making changes.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[2]/div/main/div/div/form/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('Mamak Games QA Logo')
        ...
        # -> Click the 'Save Changes' button in the Site Settings section to save changes, then save the SEO settings, and check for a visible success confirmation message.
        frame = context.pages[-1]
        # Click element
